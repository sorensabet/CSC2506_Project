...
parser.add_argument('--dataset_A_dir', dest='dataset_A_dir', default='major', help='path of the dataset of domain A')
parser.add_argument('--dataset_B_dir', dest='dataset_B_dir', default='minor', help='path of the dataset of domain B')
...
if __name__ == '__main__':
    ...
    if args.type == 'cyclegan':
        model = CycleGAN(args)
        rv = model.train(args) if args.phase == 'train' else model.test(args)
